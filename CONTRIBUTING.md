...
| `lint-migrations.yml` | migration hygiene |
| `oss-release-gate.yml` | Python contract tests (`tools/python`), release invariants |
| `docker-publish.yml` | multi-arch image build & push |
