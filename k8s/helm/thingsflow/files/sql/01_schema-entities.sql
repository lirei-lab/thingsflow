...
CREATE TABLE IF NOT EXISTS device_profile (
    ...
    provision_device_secret_hash varchar(255),
    default_edge_rule_chain_id uuid,
    external_id uuid,
    version BIGINT DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS device (
    ...
    software_id uuid,
    external_id uuid,
    security_status varchar(32) NOT NULL DEFAULT 'ACTIVE',
    version BIGINT DEFAULT 1,
    CONSTRAINT device_security_status_chk CHECK (security_status IN ('ACTIVE', 'SUSPENDED')),
