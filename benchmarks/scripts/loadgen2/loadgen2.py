...
def build_parser():
    ...
    def common(sp):
        ...
        # endpoints
        sp.add_argument("--api-base", default=os.environ.get("TF_API_BASE", "http://172.16.128.7:30081"))
        sp.add_argument("--ingest-base", default=os.environ.get("TF_INGEST_BASE", "http://172.16.128.7:30808"))
        sp.add_argument("--mqtt-host", default=os.environ.get("TF_MQTT_HOST", "172.16.128.7"))
        ...
        sp.add_argument("--greptime-base", default=os.environ.get("TF_GREPTIME_BASE", "http://172.16.128.7:30400"))
